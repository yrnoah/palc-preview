...
document.addEventListener('DOMContentLoaded', function () {
  var accommodationCarousel = null;
  accommodationCarousel = M.Carousel.init($('.carousel.carousel-slider.accommodation'), {
    fullWidth: true
  });
  if (accommodationCarousel) {
    setInterval(function () {
      accommodationCarousel[0].next();
    }, 5000);
  }
...
function preloadImages() {
  var arr = ['./images/Icon_logos.png', './images/Icon_headline.png', './images/Image_Accommodation_1.png', './images/Image_Accommodation_2.png', './images/Image_Accommodation_3.png', './images/Image_Accommodation_side.png'];
  var result = {};
